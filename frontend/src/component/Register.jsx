...
const Register = () => {
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="bg-pink-100 shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div className="mb-4">
          ...
          <input
            ...
            className="shadow appearance-none border border-pink-300 rounded w-full py-2 px-3 text-pink-700 leading-tight focus:outline-none focus:shadow-outline"
            required
          />
        </div>
        <div className="mb-4">
